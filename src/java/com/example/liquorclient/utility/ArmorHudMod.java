...
public class ArmorHudMod extends Module {
    ...
    private void render(DrawContext ctx) {
        ...
        CustomFontRenderer.drawString(ctx, mc.textRenderer, "Armor", drawX, drawY, 0xFFFFFFFF);
        drawY += 12;
        ...
        for (EquipmentSlot slot : slots) {
            ...
            CustomFontRenderer.drawString(ctx, mc.textRenderer, label, drawX + 20, drawY + 5, durabilityColor(stack));
            drawY += 18;
        }
    }
