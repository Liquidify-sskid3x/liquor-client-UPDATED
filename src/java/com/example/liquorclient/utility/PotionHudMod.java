...
public class PotionHudMod extends Module {
    ...
    private void render(DrawContext ctx) {
        ...
        CustomFontRenderer.drawString(ctx, mc.textRenderer, "Effects", drawX, drawY, 0xFFFFFFFF);
        drawY += 12;
        ...
        for (StatusEffectInstance effect : mc.player.getStatusEffects()) {
            ...
            CustomFontRenderer.drawString(ctx, mc.textRenderer, line, drawX, drawY, 0xFFE5EBF2);
            drawY += 11;
        }
    }
