...
public class CrackedAccountsScreen extends Screen {
    ...
    public void render(DrawContext ctx, int mouseX, int mouseY, float delta) {
        ...
        ctx.drawTextWithShadow(textRenderer, Text.literal("Cracked Accounts"), x + 12, y + 12, 0xFFFFFFFF);
        ctx.drawTextWithShadow(textRenderer, Text.literal("Selected: " + CrackedAccountManager.getSelectedName()), x + 12, y + 27, 0xFF9BA8B7);
        ...
        ctx.drawTextWithShadow(textRenderer, Text.literal(label), inputX + 6, inputY + 6, newAccountName.isEmpty() ? 0xFF6E7A8A : 0xFFFFFFFF);
        ...
        for (CrackedAccount account : accounts) {
            ...
            ctx.drawTextWithShadow(textRenderer, Text.literal(account.name()), x + 22, rowY + 5, selected ? 0xFFE9FFE6 : 0xFFC4CAD3);
            ctx.drawTextWithShadow(textRenderer, Text.literal(shortUuid(account.uuid().toString())), x + 22, rowY + 17, 0xFF7D8998);
